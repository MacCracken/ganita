# ganita — Claude Code Instructions
...
_TODO: one-or-two-sentence mission statement. What does ganita OWN in the stack? Durable — doesn't change per release._
...
cyrius build src/main.cyr build/ganita
